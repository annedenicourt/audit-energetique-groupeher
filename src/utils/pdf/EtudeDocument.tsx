 ...
 */          { label: "Type chauffage", value: val(c.typeChauffage) },
        ...
        <PdfSection title="Projection coûts énergie" rows={[
          ...
          { label: "Dépense totale cumulée 10 ans", value: val(ev.depenseTotal10ans, " €") },
        ]} />
        ...
        <PdfSection title="Dimensionnement" rows={[
          ...
          { label: "Photovoltaïque conso élec annuelle", value: val(dim.consommationPVElecAnnuelle, " kW/an") },
          { label: "Photovoltaïque puissance recommandée", value: val(dim.puissancePVRecommandee, " kWc") },
          { label: "Photovoltaïque production estimée", value: val(dim.productionPVEstimee, " kW/an") },
          { label: "Photovoltaïque batterie physique reco", value: val(dim.batteriePhysiqueReco, " kW") },
          { label: "Photovoltaïque batterie virtuelle reco", value: val(dim.batterieVirtuelleReco, " kW/mois") },
